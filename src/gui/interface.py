...
class FilePatcherApp(QWidget):
    ...
    def show_help(self):
        instructions = (
            ...
            "роздільній здатності - 512х512 пікселів в 30 fps.\n\n"
            "2. Ваш файл може бути в будь-якому відео форматі. Якщо це не .webm - у вас зʼявиться можливість "
            ...
            "від вхідного відео.\n\n"
            "3. Кнопка \"пропатчити\" (також автоматично застосовується після конвертації) редагує метадані вашого "
